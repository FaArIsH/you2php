        ...
        <div class="col-md-8 col-sm-12 col-xs-12 col-lg-8 leffix">
            ...
            <div class="vinfo fsize2 clearfix">
                ...
                <span class="pull-right">
                    ...
                    <i class="fa fa-share-square-o pr-1"></i>Share it
                </span>
                <span class="pr-1">
                    <a href="./content.php?cont=video&v=<?php echo $videodata['items']['0']['id'] ?>" target="_blank" class="fsize2"><i class="fa fa-arrow-down pr-1"></i>Load</a>
                </span>
                <span class="pr-1">
